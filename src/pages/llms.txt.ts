...
import { buildLlmsTxt, getPublicSeoRoutesWithOfficialPrices } from '../seo-routes.js';
import { publicSiteUrl } from '../site.js';
import { loadOfficialPrices } from '../store.js';

export const GET: APIRoute = async () => {
  const groups = buildOfficialPriceGroups(await loadOfficialPrices());
  return new Response(buildLlmsTxt(publicSiteUrl, getPublicSeoRoutesWithOfficialPrices(groups)), {
    headers: {
