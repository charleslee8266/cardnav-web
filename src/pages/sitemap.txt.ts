...
import { buildSitemapTxt, getPublicSeoRoutesWithDynamicPages } from '../seo-routes.js';
...
export const GET: APIRoute = async () => {
  ...
  return new Response(buildSitemapTxt(publicSiteUrl, getPublicSeoRoutesWithDynamicPages({ officialPriceGroups, modelLeaderboardGroups })), {
    headers: {
