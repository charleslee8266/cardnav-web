...
export const publicReadApiCloudflareCacheControl = 'public, max-age=60, stale-while-revalidate=300';
export const publicHtmlCacheControl = 'public, max-age=60, stale-while-revalidate=300';
export const publicDynamicHtmlCacheControl = 'public, max-age=300, stale-while-revalidate=1800, stale-if-error=86400';
