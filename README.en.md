...
| [2. Choose an AI Subscription Usage Method](content/guide/en/200-choose-usage-method.md) | Compare five ways to use AI models: API relay, ready-made accounts, third-party top-up, self-registration, and self-hosted relay, including their barriers, risks, and suitable users. |
| &nbsp;&nbsp;&nbsp;&nbsp;[2.1 AI Model API Relay](content/guide/en/211-usage-api-relay.md) | Quickly obtain model API access through an API relay, suitable for low-barrier trials, multi-model access, and lightweight development/debugging. |
...
| &nbsp;&nbsp;&nbsp;&nbsp;[2.5 Self-Hosted AI Model Relay](content/guide/en/215-usage-self-hosted-relay.md) | Buy official quota and host your own relay API, suitable for users with technical background who need team sharing and internal integration. |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Cloud Server Recommendations](content/guide/en/322-tool-vps.md) | Prepare a more controllable overseas host environment for self-hosted nodes or self-hosted relay services. |
